...
<script>
    ...
    button.addEventListener('click', function() {
        ...
        document.getElementById('marginPersen').value = margin;

        // Hitung default harga jual pertama kali
        document.getElementById('hargaJual').value = hargaBeli;

        // Tambahkan event listener untuk perhitungan dinamis
        document.getElementById('marginPersen').addEventListener('input', hitungHargaJual);
        document.getElementById('hargaBeli').addEventListener('input', hitungHargaJual);
...
function hitungHargaJual() {
    const hargaBeliVal = parseFloat(document.getElementById('hargaBeli').value) || 0;
    const margin = parseFloat(document.getElementById('marginPersen').value) || 0;
    const hargaJual = hargaBeliVal + (hargaBeliVal * (margin / 100));
