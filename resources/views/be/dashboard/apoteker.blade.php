...
<div class="px-4 mt-4">
    ...
    <div class="text-center my-4">
        <h2 class="section-title">📊 Statistik Pembelian, Obat, Jenis Obat & Distributor</h2>
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="card border-start border-4 border-success shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="text-success">{{ $jumlahJenisObat }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card border-start border-4 border-success shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="text-success">{{ $jumlahPembelian }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card border-start border-4 border-success shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h3 class="text-success">{{ $jumlahDistributor }}</h3>
                </div>
            </div>
        </div>
